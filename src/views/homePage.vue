  ...
  <div id="home-page">
    ...
    <nav class="navbar">
      <div class="navbar-content">
        <!-- Icono PNG -->
        <img
          src="@/assets/icons/espacio-exterior.png"
          alt="Icono Galaxia"
          class="navbar-icon"
        />
    ...
    <div class="content-wrapper">
      ...
      <div class="sidebar">
        <ul>
          <li>
            <button @click="activeView = 'limpiezaPage'">
              Limpieza energética
            </button>
          </li>
          <li>
            <button @click="activeView = 'registrosPage'">
              Registros Akashicos
            </button>
          </li>
          <li><button @click="activeView = 'reikiPage'">Reiki Usui</button></li>
          <li>
            <button @click="activeView = 'tarotPage'">Tarot Evolutivo</button>
          </li>
